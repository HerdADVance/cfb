...
<html lang="en">
  <head>
    ...
    <meta charset="UTF-8">
    <title>Texas Longhorns | Follege Cootball</title>
    ...
    <style>
        ...
        .pri{background: #bf5700;}
        .sec{background: #fff;}
        .ter{background: #333f48;}
        .pri-text{color: #bf5700;}
        .sec-text{color: #fff;}
        .ter-text{color: #333f48;}

        .nav li{background: #333f48;}
        .nav li a{color: #fff;}
        .nav li:hover{background: #fff;}
        .nav li:hover > a{color: #bf5700;}
  ...
  <body class="team texas">
            ...
            <article class="team-article">
                <div class="row">
                    <div class="team-content col-8">
                        <h1 class="team-title">Texas Longhorns</h1>
                        <p>Is Texas Back?&trade; Joe Tessitore certainly jumped the gun after the Longhorns' thrilling overtime defeat of Notre Dame back on Labor Day weekend in 2016, but it appears that Tom Herman has finally turned his team into a legitimate Big XII and national player for the forseeable future.</p>
                        <p>Texas's offense didn't provide fantasy players with an abundance of options in 2018, but it did produce three absolute studs in sophomore QB <strong>Sam Ehlinger</strong> and his top two targets &mdash; juniors <strong>Lil'Jordan Humphrey</strong> and <strong>Collin Johnson</strong>. Humphrey is off to the NFL, but Ehlinger and Johnson return as elite 2019 fantasy targets at their respective positions.</p>
                        <p>As mentioned, there wasn't much to get excited about after those three. Running back was almost a perfect time share between senior <strong>Tre Watson</strong> and true freshman <strong>Keaontay Ingram</strong>, and Ehlinger hogged too many of the rushing TD's for either to provide consistent production. The good news is that Ingram was the much more talented back and could very well be a true bellcow as a sophomore in 2019.</p>
                        ...
                        <p>That leaves the junior Young as the backup for now, but he won't carry any fantasy relevance as long as Ingram is healthy. In dynasty leagues, the other guy to target is 4* true freshman <strong>Derrian Brown</strong>. The #13 rated RB in the 2019 class could very well usurp Young as the backup before the year is over and is the most likely successor to Ingram down the line.</p>
                        <h2>Wide Receiver</h2>
                        <p>After a few years with little to no fantasy value at the position, the resurgent Longhorn offense wound up with two top-30 receivers &mdash; Humphrey (#5) and <strong>Collin Johnson</strong> (#28) &mdash; when the year was done. Johnson was supposed to be the man after leading all other pass catchers by over 300 yards in 2017, but Humphrey was a 6'4" terror in the slot. His 1176 yards were the most by a Longhorn WR since Jordan Shipley in 2009.</p>
                        ...
                        <p>Somebody not familiar with the situation might take a look and expect the 5'11" <strong>Devin Duvernay</strong> to have been playing from the slot alongside his taller counterparts, but he was and should remain the starting flanker on the outside. Although he's now easily the 2nd most established receiver on the team, can we expect a jump in production when he's playing the same position?</p>
                        <p>I think the answer is yes, but only moderately. Humphrey's slot role will be filled by a youngster with little experience so it's unlikely that player or rotation of players will even come close to matching Lil'Jordan's numbers. In theory, that leaves more targets for Duvernay, but it's far from certain he'll see enough of a bump to approach Johnson's 2018 production. The senior is a solid pick with a pretty good floor, but don't expect top-30 production out of him.</p>
                        <p>That brings us to the question of who's going to take over the coveted starting slot position. With so much young talent needing a chance to prove what they've got, a platoon seems likely here, especially early in the season. If you can find the starter, they should have some fantasy value in 2019, but the greater focus here is on dynasty stashes for 2020 and beyond.</p>
                        <p>The most valuable of those stashes is probably 4* true freshman <strong>Jake Smith</strong>. He's the #12 WR in the 2019 class and expected to contribute immediately with a chance to be the starter from day one. <strong>Joshua Moore</strong> is the 3rd leading returning receiver on the team, but that's only with a line of 7-53-1. The 4* WR was getting playing time right away as a true freshman before getting injured last year so he'll be back as a deep sleeper for 2019 but with plenty of potential for the future. DB <strong>D'Shawn Jamison</strong> caught 4 passes as a receiver last year, but he could very well return to his natural position this season.</p>
                        ...
                        <p>Junior <strong>Cade Brewer</strong> is your likely starter. He went for 7-90-2 in 2017 as a true freshman when Beck missed the season with an injury. Sophomore <strong>Reese Leitao</strong> could also be in the picture, and true freshman <strong>Brayden Liebrock</strong> is a 4* prospect who is good enough to see time immediately and could be a fantasy consideration in 2020 and beyond.</p>
                    ...
                    <div class="team-sidebar col-4">
                        ...
                        <table>
                            ...
                            <tr><td>QB</td><td>Sam Ehlinger</td><td>5</td></tr>
                            <tr><td>WR</td><td>Collin Johnson</td><td>8</td></tr>
                            <tr><td>RB</td><td>Keaontay Ingram</td><td>22</td></tr>
                            <tr><td>WR</td><td>Devin Duvernay</td><td>72</td></tr>
                            <tr><td>WR</td><td>Joshua Moore</td><td>151</td></tr>
                            <tr><td>WR</td><td>Brennan Eagles</td><td>162</td></tr>
                        </table>

                        <h1>Dynasty Stashes</h1>
                        <table>
                            <tr><th>Pos</th><th>Name</th><th>Rank</th></tr>
                            <tr><td>WR</td><td>Jordan Whittington</td><td>8</td></tr>
                            <tr><td>WR</td><td>Jake Smith</td><td>72</td></tr>
                            <tr><td>W/T</td><td>Malcolm Epps</td><td>5</td></tr>
                            <tr><td>QB</td><td>Cameron Rising</td><td>72</td></tr>
                            <tr><td>QB</td><td>Casey Thompson</td><td>77</td></tr>
                            <tr><td>WR</td><td>Marcus Washington</td><td>22</td></tr>
                        </table>

                        <h1>2019 Schedule</h1>
                        <table class="team-sidebar-schedule">
                            <tr><th>Date</th><th>Opponent</th></tr>
                            <tr class="home"><td>8/31</td><td>Louisiana Tech</td></tr>
                            <tr class="home"><td>9/7</td><td>LSU</td></tr>
                            <tr><td>9/14</td><td>vs Rice (NRG Stadium)</td></tr>
                            <tr class="home"><td>9/21</td><td>Oklahoma State</td></tr>
                            <tr><td>10/5</td><td>@ West Virginia</td></tr>
                            <tr><td>10/12</td><td>vs Oklahoma (Dallas, TX)</td></tr>
                            <tr class="home"><td>10/19</td><td>Kansas</td></tr>
                            <tr><td>10/26</td><td>@ TCU</td></tr>
                            <tr class="home"><td>11/9</td><td>Kansas State</td></tr>
                            <tr><td>11/16</td><td>@ Iowa State</td></tr>
                            <tr><td>11/23</td><td>@ Baylor</td></tr>
                            <tr class="home"><td>11/29</td><td>Texas Tech</td></tr>
                        </table>

                        <h1>Beat Writers</h1>
                        <table class="team-sidebar-twitter">
                            <tr><th>Name</th><th>Outlet</th></tr>
                            <tr><td><a href="https://twitter.com" target="_BLANK">Grant Traylor</a></td><td>Herald-Dispatch</td></tr>
                        </table>
  	...
  	<footer class="footer wrap-bg centered pri">
  		<p class="no-mar-y sec-text">&copy; 2019 Follege Cootball</p>
  	</footer>
